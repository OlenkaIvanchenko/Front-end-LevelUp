...
function createFormRow(title, type = 'text',name = null, placeholder = null) {
    ...
    if (type === 'file') {
        input.accept = "image/*"; // Приймаються лише зображення
    }
...
function createItem(item) {
    ...
    itemDiv.id = item.id;
    const defaultImgUrl = "./free-icon-world-book-day-9673624.png"; // Замінити своїм посиланням
    const imgUrl = item.imgUrl || defaultImgUrl;
